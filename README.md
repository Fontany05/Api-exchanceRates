...
Hay otras manera de realizar desde y github y desde nuestro editor de codigo ejemplo vscode,ademas hay una configuracion extra despues del deploy la cual clave de api,la cadena de conexion,etc y en el caso de node debemos asegurarnos de que el servidor escuche en process.env.PORT
